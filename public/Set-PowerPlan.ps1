function Set-PowerPlan {
	...
	.LINK
		https://github.com/Skatterbrainz/ds-utils/blob/master/docs/Set-PowerPlan.md
	#>
	[CmdletBinding()]
	param (
	...
	try {
		...
		if ($Name -eq 'Custom') {
			...
			switch ($Name) {
				'HighPerformance' { $ppguid = '8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c' }
				'Performance' {	$ppguid = '9586a712-fcb4-4a06-af4b-52803dfbb9db' }
				'Balanced'    { $ppguid = '381b4222-f694-41f0-9685-ff5bb260df2e' }
				'PowerSaver'  { $ppguid = 'a1841308-3541-4fab-bc81-f71556f20b4a' }
				'EnergyStar'  { $ppguid = 'de7ef2ae-119c-458b-a5a3-997c2221e76e' }
			}
			...
			if ($currentScheme[3] -ne $ppguid) {
				...
				Write-Host "Current plan is already $Name"
			}
		}
		Write-Output $result
	}
