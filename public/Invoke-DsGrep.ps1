...
.LINK
	https://github.com/Skatterbrainz/ds-utils/blob/master/docs/Invoke-DsGrep.md
#>
...
New-Alias -Name grep -value Invoke-DsGrep -Description "What's eating Gilbert Grep?"